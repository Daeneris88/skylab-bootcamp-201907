...
class Landing extends Component {
    ...
    render() {
        return <>
            ...
            {this.state.visible === "register" && <Register  onNavReg ={this.handleRegister} onBack={() => this.setState({ visible: "landing"})} />}
            {this.state.visible === "login" && <Login  onNavLog ={this.handleLogin} onBack={() => this.setState({ visible: "landing"})} />}
            ...
            {!this.state.duck ?
                ...
                :
                this.state.visible === "landing" && <DuckDetail duck={this.state.duck} onBack={() => this.setState({ duck: undefined})} />}
